...
const openedMsg = document.getElementById('openedMsg');
...
envelopeTrigger.addEventListener('click', () => {
  envelopeTrigger.classList.toggle('open');
  const isOpen = envelopeTrigger.classList.contains('open');
  openedMsg.hidden = !isOpen;
  readLetterBtn.hidden = !isOpen;
});
